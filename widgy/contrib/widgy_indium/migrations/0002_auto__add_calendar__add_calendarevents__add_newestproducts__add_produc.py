...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'widgy_indium_calendar', (
            ...
            ('calendar_url', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('show_header', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('header_left', self.gf('django.db.models.fields.CharField')(default='title', max_length=100)),
            ('header_center', self.gf('django.db.models.fields.CharField')(default='month,agendaWeek,agendaDay', max_length=100)),
            ('header_right', self.gf('django.db.models.fields.CharField')(default='today prev,next prevYear,nextYear', max_length=100)),
            ('first_day', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('show_week_number', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('agenda_time_format', self.gf('django.db.models.fields.CharField')(default='H:mm{ - H:mm}', max_length=50)),
            ('time_format', self.gf('django.db.models.fields.CharField')(default='H:mm', max_length=50)),
            ('column_format_month', self.gf('django.db.models.fields.CharField')(default='ddd', max_length=50)),
            ('column_format_week', self.gf('django.db.models.fields.CharField')(default='ddd dd.MM.', max_length=50)),
            ('column_format_day', self.gf('django.db.models.fields.CharField')(default='dddd dd.MM.', max_length=50)),
            ('event_background_color', self.gf('django.db.models.fields.CharField')(default='rgba(255,255,255,0.2)', max_length=50)),
            ('event_border_color', self.gf('django.db.models.fields.CharField')(default='#ddd', max_length=50)),
            ('event_text_color', self.gf('django.db.models.fields.CharField')(default='#333', max_length=50)),
        ))
        db.send_create_signal('widgy_indium', ['Calendar'])

        # Adding model 'CalendarEvents'
        db.create_table(u'widgy_indium_calendarevents', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('container_classes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('calendar_url', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ...
        db.create_table(u'widgy_indium_blogpostlist', (
            ...
            ('post_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=5)),
        ))
        db.send_create_signal('widgy_indium', ['BlogPostList'])
        
        # Adding field 'WidgetPage.title_fi'
        db.add_column(u'widgy_indium_widgetpage', 'title_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetPage.title_en'
        db.add_column(u'widgy_indium_widgetpage', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetPage._meta_title_fi'
        db.add_column(u'widgy_indium_widgetpage', '_meta_title_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetPage._meta_title_en'
        db.add_column(u'widgy_indium_widgetpage', '_meta_title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetPage.description_fi'
        db.add_column(u'widgy_indium_widgetpage', 'description_fi',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetPage.description_en'
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'widgy_indium_calendar')

        # Deleting model 'CalendarEvents'
        db.delete_table(u'widgy_indium_calendarevents')

        # Deleting model 'NewestProducts'
        db.delete_table(u'widgy_indium_newestproducts')

        # Deleting model 'ProductsViewer'
        db.delete_table(u'widgy_indium_productsviewer')

        # Deleting model 'BlogPostList'
        db.delete_table(u'widgy_indium_blogpostlist')

        # Deleting field 'WidgetPage.title_fi'
        db.delete_column(u'widgy_indium_widgetpage', 'title_fi')

        # Deleting field 'WidgetPage.title_en'
        db.delete_column(u'widgy_indium_widgetpage', 'title_en')

        # Deleting field 'WidgetPage._meta_title_fi'
        db.delete_column(u'widgy_indium_widgetpage', '_meta_title_fi')

        # Deleting field 'WidgetPage._meta_title_en'
        db.delete_column(u'widgy_indium_widgetpage', '_meta_title_en')

        # Deleting field 'WidgetPage.description_fi'
        db.delete_column(u'widgy_indium_widgetpage', 'description_fi')

        # Deleting field 'WidgetPage.description_en'
        db.delete_column(u'widgy_indium_widgetpage', 'description_en')
