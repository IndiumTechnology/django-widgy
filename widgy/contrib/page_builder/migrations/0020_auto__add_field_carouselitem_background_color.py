...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CarouselItem.background_color'
        db.add_column(u'page_builder_carouselitem', 'background_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CarouselItem.background_color'
        db.delete_column(u'page_builder_carouselitem', 'background_color')
