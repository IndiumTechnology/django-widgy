...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'page_builder_container')

        # Deleting model 'CarouselItem'
        db.delete_table(u'page_builder_carouselitem')
        ...
        # Deleting field 'Image.image_width'
        db.delete_column(u'page_builder_image', 'image_width')

        # Deleting field 'Image.crop'
        db.delete_column(u'page_builder_image', 'crop')

        # Deleting field 'Image.image_height'
        db.delete_column(u'page_builder_image', 'image_height')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'page_builder_container', (
            ('container_classes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'page_builder', ['Container'])

        # Adding model 'CarouselItem'
        db.create_table(u'page_builder_carouselitem', (
            ('background_image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['filer.File'], on_delete=models.PROTECT, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('background_color', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            ('container_classes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'page_builder', ['CarouselItem'])
        ...
        # Adding field 'Image.image_width'
        db.add_column(u'page_builder_image', 'image_width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.crop'
        db.add_column(u'page_builder_image', 'crop',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Image.image_height'
        db.add_column(u'page_builder_image', 'image_height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'page_builder.image': {
            ...
            'container_classes': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['filer.File']"})
        },
