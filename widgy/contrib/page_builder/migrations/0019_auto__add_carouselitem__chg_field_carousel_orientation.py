...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Carousel.orientation'
        db.alter_column(u'page_builder_carousel', 'orientation', self.gf('django.db.models.fields.BooleanField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Carousel.orientation'
        db.alter_column(u'page_builder_carousel', 'orientation', self.gf('django.db.models.fields.CharField')(max_length=10))
