...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'page_builder_image', 'width')

        # Deleting field 'Image.height'
        db.delete_column(u'page_builder_image', 'height')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'page_builder_image', 'width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=500, null=True),
                      keep_default=False)

        # Adding field 'Image.height'
        db.add_column(u'page_builder_image', 'height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=500, null=True),
                      keep_default=False)
