...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Carousel.pause_scroll_on_hover'
        db.add_column(u'page_builder_carousel', 'pause_scroll_on_hover',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Carousel.pause_scroll_on_hover'
        db.delete_column(u'page_builder_carousel', 'pause_scroll_on_hover')
