...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'widgy_i18n_layoutcontainer', (
        ...
        db.send_create_signal(u'widgy_i18n', ['LayoutContainer'])

        # Adding model 'WidgetPage'
        db.create_table(u'widgy_i18n_widgetpage', (
        ...
        db.send_create_signal(u'widgy_i18n', ['WidgetPage'])


    def backwards(self, orm):
        # Deleting model 'LayoutContainer'
        db.delete_table(u'widgy_i18n_layoutcontainer')

        # Deleting model 'WidgetPage'
        db.delete_table(u'widgy_i18n_widgetpage')
